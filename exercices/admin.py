...
class ExerciceAdmin(admin.ModelAdmin):
    list_display = ('titre', 'type_exercice', 'matiere', 'periode', 'coefficient', 'nombre_points', 'actif', 'date_creation')
    list_filter = ('type_exercice', 'matiere', 'periode', 'actif')
    search_fields = ('titre', 'description')
    fields = ('titre', 'description', 'type_exercice', 'matiere', 'periode', 'coefficient', 'image_support', 'texte_support', 'actif', 'date_limite')

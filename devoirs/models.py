...
class Devoir(models.Model):
    ...
    matiere = models.ForeignKey(
        'cours.Matiere', on_delete=models.SET_NULL, null=True, blank=True, related_name='devoirs',
    )
    ...
    groupe = models.ForeignKey(
        'scolarite.Groupe', on_delete=models.SET_NULL, null=True, blank=True, related_name='devoirs',
        verbose_name="Groupe",
    )
    classe = models.ForeignKey(
        'scolarite.Classe', on_delete=models.SET_NULL, null=True, blank=True, related_name='devoirs',
        verbose_name="Classe",
        help_text="Pour organiser/filtrer (primaire / secondaire).",
    )
    filiere = models.ForeignKey(
        'scolarite.Filiere', on_delete=models.SET_NULL, null=True, blank=True, related_name='devoirs',

...
Commande pratique pour creer rapidement un compte etudiant en ligne de commande :
    ...
    python manage.py creer_etudiant nom_utilisateur mot_de_passe --nom "Kouassi Jean" --classe "L2 Info"
"""
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--classe', type=str, default='')
    ...
    def handle(self, *args, **options):
        ...
        Profil.objects.filter(utilisateur=user).update(
            role=Profil.ETUDIANT, classe=options['classe']
        )
